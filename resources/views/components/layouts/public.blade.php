    ...
    <div class="max-w-[1160px] mx-auto px-6 py-16">
        <div class="grid grid-cols-2 md:grid-cols-5 gap-8 md:gap-12">
            ...
            <div class="col-span-2 md:col-span-2">
                ...
                <p class="text-base text-gray-500 leading-relaxed max-w-xs">
                    Building premium digital products for businesses across Africa and beyond.
                </p>
                <div class="flex flex-wrap items-center gap-2 mt-6">
                    {{-- Facebook --}}
                    <a href="#" aria-label="Facebook" class="w-8 h-8 rounded-xl bg-gray-100 hover:bg-blue-600 hover:text-white text-gray-500 flex items-center justify-center transition-all duration-150">
                    ...
                    {{-- Instagram --}}
                    <a href="#" aria-label="Instagram" class="w-8 h-8 rounded-xl bg-gray-100 hover:bg-pink-500 hover:text-white text-gray-500 flex items-center justify-center transition-all duration-150">
                    ...
                    {{-- X / Twitter --}}
                    <a href="#" aria-label="X" class="w-8 h-8 rounded-xl bg-gray-100 hover:bg-black hover:text-white text-gray-500 flex items-center justify-center transition-all duration-150">
                    ...
                    {{-- TikTok --}}
                    <a href="#" aria-label="TikTok" class="w-8 h-8 rounded-xl bg-gray-100 hover:bg-black hover:text-white text-gray-500 flex items-center justify-center transition-all duration-150">
                        <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.79 1.52V6.76a4.84 4.84 0 01-1.02-.07z"/></svg>
                    </a>
                    {{-- GitHub --}}
                    <a href="#" aria-label="GitHub" class="w-8 h-8 rounded-xl bg-gray-100 hover:bg-gray-900 hover:text-white text-gray-500 flex items-center justify-center transition-all duration-150">
                    ...
                    {{-- LinkedIn --}}
                    <a href="#" aria-label="LinkedIn" class="w-8 h-8 rounded-xl bg-gray-100 hover:bg-blue-700 hover:text-white text-gray-500 flex items-center justify-center transition-all duration-150">
                        <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                    </a>
                    {{-- Discord --}}
                    <a href="#" aria-label="Discord" class="w-8 h-8 rounded-xl bg-gray-100 hover:bg-indigo-600 hover:text-white text-gray-500 flex items-center justify-center transition-all duration-150">
            ...
            <div>
                <h4 class="text-[18px] font-bold text-black mb-5">Company</h4>
            ...
            <div>
                <h4 class="text-[18px] font-bold text-black mb-5">Explore</h4>
                <ul class="space-y-3.5 text-base">
            ...
            <div>
                <h4 class="text-[18px] font-bold text-black mb-5">Support</h4>
                <ul class="space-y-3.5 text-base">
